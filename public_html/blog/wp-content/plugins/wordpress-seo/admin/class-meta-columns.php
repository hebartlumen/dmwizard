...
class WPSEO_Meta_Columns {
	...
	private function render_score_indicator( $rank, $title = '' ) {
		...
		return '<div aria-hidden="true" title="' . esc_attr( $title ) . '" class="' . esc_attr( 'wpseo-score-icon ' . $rank->get_css_class() ) . '"></div><span class="screen-reader-text">' . esc_html($title ). '</span>';
	}
