...
if ( $import ) {
	...
	if ( $msg != '' ) {
		...
		echo '<div id="message" class="message ', esc_attr( $status ), '"><p>', esc_html( $msg ), '</p></div>';
	}
}
...
?>
	...
	<h2 class="nav-tab-wrapper" id="wpseo-tabs">
		<?php foreach ( $tabs as $identifier => $tab ) : ?>
			<a class="nav-tab" id="<?php echo $identifier; ?>-tab" href="#top#<?php echo $identifier; ?>"><?php echo esc_html( $tab['label'] ); ?></a>
		<?php endforeach; ?>
