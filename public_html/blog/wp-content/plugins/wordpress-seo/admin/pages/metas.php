...
function yoast_add_meta_options_help_center_tabs( $tabs ) {
	$tabs[] = new WPSEO_Help_Center_Item(
		...
		array(
			'content' => "\n\t\t<h2>" . esc_html( __( 'Template explanation', 'wordpress-seo' ) ) . "</h2>\n\t\t" . '<p>' .'<p>' .
				sprintf(
					...
					'Yoast SEO' ) .
				'</p>' . '<p>' . esc_html( __( 'Note that not all variables can be used in every template.', 'wordpress-seo' ) ) . '</p>',
		)
	);
	...
	$tabs[] = new WPSEO_Help_Center_Item(
		...
		array(
			'content' => '<h2>' . esc_html( __( 'Basic Variables', 'wordpress-seo' ) ). '</h2>' . WPSEO_Replace_Vars::get_basic_help_texts(),
		)
	);
	...
	$tabs[] = new WPSEO_Help_Center_Item(
		...
		array(
			'content' => '<h2>' . esc_html( __( 'Advanced Variables', 'wordpress-seo' ) ). '</h2>' . WPSEO_Replace_Vars::get_advanced_help_texts(),
		)
	);
