...
function inkness_scripts() {
	...
	wp_enqueue_style( 'overwrite-bootstrap-style', get_template_directory_uri()."/css/overwrite.css", array('inkness-layout') );
...
function enquiry_send_message() {
    ...
    $message .= "Email Address: $useremail<br>";
    $message .= "Location: $userlocation<br>";
    $message .= "Phone Number: $userphone<br>";
    $message .= "Message: $usermessage<br><br>";
    $message .= "This Mail is generated by DMWizard Enquiry Box";

    $subject = "DMWizard WP Enquiry";
    ...
    if( !wp_mail($to, $subject, $message, $header) ) {
        ...
        //return true;
        //wp_redirect( 'http://www.dmwizard.in/thankyou', 301 ); exit;
    }
    //return $contact_errors;

}
add_action('enquiry_send_message', 'enquiry_send_message');