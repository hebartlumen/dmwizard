...
function optionsframework_options() {
	...
	$options[] = array(
		'desc' => __('To have more customization options including Analytics, Custom Header/Footer Scripts <a href="https://inkhive.com/product/inkness-plus/" target="_blank">Upgrade to Pro</a> at Just $25.95'),
		'std' => '',
		'type' => 'info');
	...
	$options[] = array(
		'desc' => __('With <a href="https://inkhive.com/product/inkness-plus/" target="_blank">Pro Version</a> You also have the option to Remove Search Bar from header, and move to a full width menu. Upgrade at Just $25.95'),
		'type' => 'info');	
	...
	$options[] = array(
		'desc' => __('<a href="https://inkhive.com/product/inkness-plus/" target="_blank">Pro Version</a> supports the option to add custom skins, styles & Layouts. Upgrade at Just $25.95.'),
		'std' => '',
		'type' => 'info');
	...
	$options[] = array(
		'desc' => __('To Add your Own icons, and Choose different image styles for Social Icons, purchase <a href="https://inkhive.com/product/inkness-plus/" target="_blank">Pro Version (InkNess Plus)</a>. Upgrade at Just $25.95'),
		'std' => '',
		'type' => 'info');	

	$options[] = array(
		'name' => __('Facebook', 'inkness'),
		'desc' => __('Facebook Profile or Page URL i.e. https://facebook.com/username/ ', 'inkness'),
		'id' => 'facebook',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Google Plus profile url, including "https://"', 'inkness'),
		'id' => 'google',
		'std' => '',
		'class' => 'mini',
		'type' => 'text');
	...
	$options[] = array(
		'desc' => __('More social Icons are available in the <a href="https://inkhive.com/product/inkness-plus/" target="_blank">Pro Version (InkNess Plus)</a>. Upgrade at Just $25.95'),
		'std' => '',
		'type' => 'info');							
	...
	$options[] = array(
		'desc' => __('Inkness WordPress theme has been Designed and Created by <a href="https://InkHive.com" target="_blank">Rohit Tripathi</a>. For any Queries or help regarding this theme, <a href="https://wordpress.org/support/theme/inkness/" target="_blank">use the support forums.</a>', 'inkness'),
		'type' => 'info');		
		
	 $options[] = array(
		'desc' => __('<a href="https://twitter.com/rohitinked" target="_blank">Follow Me on Twitter</a> to know about my upcoming themes.', 'inkness'),
		'type' => 'info');
		
	$options[] = array(
		'name' => __('Live Demo Blog', 'inkness'),
		'desc' => __('For your convenience, we have created a <a href="https://demo.inkhive.com/inkness/" target="_blank">Live Demo Blog</a> of the theme Inkness. You can take a look at and find out how your site would look once complete.', 'inkness'),
		'type' => 'info');		
		
	$options[] = array(
		'desc' => __('We Offer Dedicated Personal Support to all our <a href="https://inkhive.com/product/inkness-plus/" target="_blank">Pro Version Customers</a>. Upgrade at Just $25.95'),
		'std' => '',
		'type' => 'info');			
